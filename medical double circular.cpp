...
// Function to insert a doctor at the end of the double circular list
...
int main() {
    ...
    // Display the double circular list of doctors
    printf("\nList of Doctors:\n");
    displayList(head);
    ...
    // Display the updated double circular list
    printf("\nUpdated List:\n");
    displayList(head);
